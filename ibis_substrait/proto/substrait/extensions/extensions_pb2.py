...
SimpleExtensionDeclaration = _reflection.GeneratedProtocolMessageType('SimpleExtensionDeclaration', (_message.Message,), {'ExtensionType': _reflection.GeneratedProtocolMessageType('ExtensionType', (_message.Message,), {'DESCRIPTOR': _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPE, '__module__': 'substrait.extensions.extensions_pb2'}), 'ExtensionTypeVariation': _reflection.GeneratedProtocolMessageType('ExtensionTypeVariation', (_message.Message,), {'DESCRIPTOR': _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPEVARIATION, '__module__': 'substrait.extensions.extensions_pb2'}), 'ExtensionFunction': _reflection.GeneratedProtocolMessageType('ExtensionFunction', (_message.Message,), {'UserDefinedFunction': _reflection.GeneratedProtocolMessageType('UserDefinedFunction', (_message.Message,), {'DESCRIPTOR': _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION_USERDEFINEDFUNCTION, '__module__': 'substrait.extensions.extensions_pb2'}), 'DESCRIPTOR': _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION, '__module__': 'substrait.extensions.extensions_pb2'}), 'DESCRIPTOR': _SIMPLEEXTENSIONDECLARATION, '__module__': 'substrait.extensions.extensions_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SIMPLEEXTENSIONDECLARATION._serialized_end = 1333
    ...
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION._serialized_end = 1317
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION_USERDEFINEDFUNCTION._serialized_start = 1116
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION_USERDEFINEDFUNCTION._serialized_end = 1317
    _ADVANCEDEXTENSION._serialized_start = 1336
    _ADVANCEDEXTENSION._serialized_end = 1469