...
class ReadRel(google.protobuf.message.Message):
    ...
    class LocalFiles(google.protobuf.message.Message):
        ...
        class FileOrFiles(google.protobuf.message.Message):
            ...
            @typing.overload
            def WhichOneof(self, oneof_group: typing_extensions.Literal['file_format', b'file_format']) -> typing.Optional[typing_extensions.Literal['parquet', 'arrow', 'orc', 'extension', 'dwrf']]:
                ...
