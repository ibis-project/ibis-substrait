...
class PlanVersion(google.protobuf.message.Message):
    ...
    def __init__(self, *, version: typing.Optional[global___Version]=...) -> None:
        ...
...
class Version(google.protobuf.message.Message):
    ...
    def __init__(self, *, major_number: builtins.int=..., minor_number: builtins.int=..., patch_number: builtins.int=..., git_hash: typing.Text=..., producer: typing.Text=...) -> None:
        ...
